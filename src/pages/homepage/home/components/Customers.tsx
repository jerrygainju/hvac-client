...
const Customer = () => {
    ...
    return (
        <div className="flex flex-row pt-12 gap-4 px-8">
            <div ref={ref} className={`flex flex-col border  rounded-xl shadow-2xl bg-gray-200 ${inView ? 'slide-from-left' : ''}`}>
                ...
                <div className="font-mono text-2xl pt-8 text-center text-gray-600">
            ...
            <div ref={ref} className={`${inView ? 'slide-from-right' : ''}`}>
                <Image src={Company} width={700} height={450} className='rounded-2xl shadow-2xl' />
            </div>
