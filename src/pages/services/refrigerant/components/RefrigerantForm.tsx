...
interface RefrigerantFormProps {
    ...
    selectRefrigerantType: any;
    handleRefrigerantType: (event: React.ChangeEvent<HTMLSelectElement>) => void;
}
                                ...
                                <div className="flex flex-col items-center font-mono gap-1 text-gray-600 pl-4">
                                    ...
                                    <div>
                                        <select
                                            ...
                                            value={selectRefrigerantType}
                                            onChange={handleRefrigerantType}
                                        >
                                ...
                                <div className="flex flex-col items-center  font-mono gap-2 text-gray-600 pl-4">
                                    ...
                                    {fcuList[condenserIndex].map((_fcu, fcuIndex) => (
                                        <div key={fcuIndex} className="text-base text-gray-400">
                                            {totalVolume[condenserIndex] && totalVolume[condenserIndex][fcuIndex] !== undefined ?
                                                `${totalVolume[condenserIndex][fcuIndex]} m³` :
                                                ' '}
                                        </div>
                                    ))}
                                </div>
