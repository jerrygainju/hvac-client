...
const ContactUs = () => {
  ...
  return (
    <div className="w-screen">
      ...
      <div className="lg:flex flex-row gap-12 mt-8 justify-center">
        <div className="md:mx-auto sm:mx-auto mx-auto lg:flex flex-col lg:w-3/12 md:w-1/2 w-auto p-6 bg-gray-200 border rounded-xl shadow-2xl text-gray-600 card">
        ...
        <div className="md:mx-auto sm:mx-auto mx-auto flex flex-col border rounded-xl px-12 pt-12 shadow-2xl gap-10 bg-gray-200 text-gray-600 w-96 card">
